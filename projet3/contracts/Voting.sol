...
// Import de ReentrancyGuard pour protéger contre les attaques de réentrance
...
contract Voting is Ownable, ReentrancyGuard {
    ...
    enum  WorkflowStatus {
        // État 0 : enregistrement des votants
        RegisteringVoters,
        // État 1 : début de l'enregistrement des propositions
        ProposalsRegistrationStarted,
        // État 2 : fin de l'enregistrement des propositions
        ProposalsRegistrationEnded,
        // État 3 : début de la session de vote
        VotingSessionStarted,
        // État 4 : fin de la session de vote
        VotingSessionEnded,
        // État 5 : votes comptabilisés
        VotesTallied
    }
